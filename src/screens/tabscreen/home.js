...
import Swiper from 'react-native-swiper';
     ...
     DisHandler=()=>{
      this.props.navigation.navigate('Disnav')
          ...
          render(){
             return(
              ...
              colors={['#9F035C','#6D0F49']} style={styles.linearGradient}>
               <View >
                 <View> 
                     <CustomHeader 
      ...
      <View style={styles.discusscontainer } >
       ...
       >
        <Icon  name="calendar-alt" size={55}  color="#9F035C" alignItems='center'  />
        <Text style={{fontSize:12,textAlign:'center'}}> check here</Text>
           ...
           <TouchableOpacity >
          <Button style={styles.btnLogin1} ><Icon  name="newspaper" size={25}  color="white" alignItems='center'  />

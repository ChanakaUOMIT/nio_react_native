        ...
        return(
            <ScrollView>
                ...
                <View style={{ flexDirection:'row'}} >
                    <View style={{ width:'90%', position: 'absolute',bottom:0, alignItems: 'center', justifyContent: 'center', padding:5 }}>
            ...
            <View key={data.id} style={styles.cardContainer}>
              ...
              <View style={styles.participantList}>
                <View style={{width:  '15%', height: 75, backgroundColor: 'white',  padding:10,}}>
                    {/* <Text>Image md-contact</Text> */}
                    <Icon  name="md-contact"                    
                        size={45} color="#616161"/>
                </View>
                  <View style={{width: '60%', height: 75, backgroundColor: 'white',  padding:10,}} >
